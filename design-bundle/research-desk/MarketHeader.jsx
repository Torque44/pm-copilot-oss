  ...
  return (
    <div className="market-header">
      ...
      <button className="mh-criteria" onClick={() => setExpanded(!expanded)}>
        ...
        {!expanded && <span className="mh-criteria-preview">{market.criteria.slice(0, 80)}…</span>}
      </button>
        ...
        <div className="mh-multi">
          {market.outcomes.map((o, i) => (
            <div key={i} className="multi-row">
              ...
              <span className="multi-bar"><span className="multi-bar-fill" style={{ width: (o.yes * 100) + '%' }} /></span>
